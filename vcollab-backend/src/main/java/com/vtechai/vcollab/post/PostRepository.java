...
public interface PostRepository extends JpaRepository<Post, Long> {
    @Query("""
        ...
        where p.deletedAt is null
          ...
          and (
            :search is null
            or lower(coalesce(p.content, '')) like lower(concat('%', :search, '%'))
    ...
    Page<Post> findByVisibilityAndActiveTrueAndDeletedAtIsNull(Visibility visibility, Pageable pageable);
    Page<Post> findByAuthorUsernameAndVisibilityAndDeletedAtIsNull(
        String username,
        Visibility visibility,
        Pageable pageable
    );
    Page<Post> findByAuthorAndDeletedAtIsNull(User author, Pageable pageable);
    List<Post> findByAuthorIdInAndVisibilityAndActiveTrueAndDeletedAtIsNull(
        List<Long> authorIds,
        Visibility visibility,
        Pageable pageable
    );
