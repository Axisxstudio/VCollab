...
import ResourcesExplorerPage from "../pages/resources/ResourcesExplorerPage";
...
import VHubPage from "../pages/vhub/VHubPage";
import WarningsPage from "../pages/warnings/WarningsPage";
import AdminDashboardPage from "../pages/admin/AdminDashboardPage";
import AdminVHubPage from "../pages/admin/AdminVHubPage";
  ...
  return (
    <Routes>
      <Route element={<PublicLayout />}>
        ...
        <Route path={routes.resources} element={<ResourcesLandingPage />} />
        <Route path={routes.resourceExplore} element={<ResourcesExplorerPage />} />
        <Route path={routes.vHub} element={<VHubPage />} />
      </Route>
      ...
      <Route element={<AdminRoute />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path={routes.adminResources} element={<AdminResourcesPage />} />
          ...
          <Route path={routes.adminVHub} element={<AdminVHubPage />} />
        </Route>
      </Route>
