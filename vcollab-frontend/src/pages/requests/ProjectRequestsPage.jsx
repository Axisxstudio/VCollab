  ...
  return (
    <div className="collab-page">
      <section className="collab-page__hero">
        <div>
          <span className="collab-page__eyebrow">Collaboration workflow</span>
          <h2 className="collab-page__title">Project Requests</h2>
          <p className="collab-page__subtitle">
            Track incoming collaboration requests and monitor the ones you have already sent without leaving the workspace.
          </p>
        </div>
      </section>
