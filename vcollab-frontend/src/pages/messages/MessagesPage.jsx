  ...
  return (
    <div className="collab-page">
      <section className="collab-page__hero">
        <div>
          <span className="collab-page__eyebrow">Realtime messaging</span>
          <h2 className="collab-page__title">Messages</h2>
          <p className="collab-page__subtitle">
            Messenger-style conversations stay synced live. New chats can be started from profiles after following first.
          </p>
        </div>
      </section>
      ...
      <section className="collab-stat-grid">
        ...
        <article className="collab-stat-card">
          <span className="collab-stat-card__icon"><Search size={18} /></span>
          <div>
                      ...
                      <div className="messenger-bubble__content">
                        ...
                        {isSelf && !editingId && (
                          <div className="messenger-bubble__actions">
                            ...
                            <span className="messenger-bubble__status">
