        ...
        <div className="container">
          <div className="ap-story-inner reveal-up" style={{ "--delay": "80ms" }}>
            ...
            <div className="ap-story-body">
              <p>
                Created by <strong>VTech AI Solutions</strong>, VCollab was designed to make project collaboration more trusted, visible, and practical for people building real work.
              </p>
              <p>
